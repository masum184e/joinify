    ...
    <aside class="w-1/5 bg-slate-900 text-white p-5 space-y-6">
      ...
      <nav class="space-y-3">
        <ul class="space-y-2">
          ...
          <li><a class="block py-1 hover:text-teal-600" href="/dashboard/manage-events">Manage Events</a></li>
          <li><a class="block py-1 hover:text-teal-600" href="/dashboard/manage-membership">Manage Membership</a></li>
