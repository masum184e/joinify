...
<body class="h-screen w-screen overflow-hidden bg-gray-50 text-gray-800">
  ...
  <div class="flex h-full w-full">
    ...
    @endphp
      ...
      {{ Request::is("dashboard/clubs/{$clubId}/events*") ? 'text-blue-400 font-semibold pointer-events-none' : 'hover:text-blue-300' }}">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round"
      ...
      @endif
        ...
        <li>
        <a href="/dashboard/clubs/{{ $clubId}}/members"
          class="flex items-center space-x-2 transition-all duration-200
      {{ Request::is("dashboard/clubs/{$clubId}/members*") ? 'text-blue-400 font-semibold pointer-events-none' : 'hover:text-blue-300' }}">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round"
