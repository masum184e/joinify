    ...
    <aside class="w-1/5 bg-slate-800 text-white p-6 space-y-8 shadow-lg">
      ...
      <nav>
        <ul class="space-y-4 text-sm font-medium">
          ...
          <li>
            <a href="/dashboard/president"
              class="flex items-center space-x-2 transition-all duration-200
        {{ Request::is('dashboard/president') ? 'text-blue-400 font-semibold pointer-events-none' : 'hover:text-blue-300' }}">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
          ...
          <li>
            <a href="/dashboard/secretary"
              class="flex items-center space-x-2 transition-all duration-200
        {{ Request::is('dashboard/secretary') ? 'text-blue-400 font-semibold pointer-events-none' : 'hover:text-blue-300' }}">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
          ...
          <li>
            <a href="/dashboard/accountant"
              class="flex items-center space-x-2 transition-all duration-200
        {{ Request::is('dashboard/accountant') ? 'text-blue-400 font-semibold pointer-events-none' : 'hover:text-blue-300' }}">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        {{ Request::is('dashboard/clubs*') ? 'text-blue-400 font-semibold pointer-events-none' : 'hover:text-blue-300' }}">
          ...
          <li>
            <a href="/dashboard/log-out"
              class="flex items-center space-x-2 transition-all duration-200
              {{ Request::is('dashboard/log-out') ? 'text-blue-400 font-semibold pointer-events-none' : 'hover:text-blue-300' }}">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
      ...
      <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center space-x-4">
          <div class="text-sm text-right">
            ...
            <p class="text-xs text-gray-500">john@joinify.edu</p>
          </div>
