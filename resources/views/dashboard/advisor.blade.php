  ...
  <div class="space-y-6 mb-8">
    ...
    <div class="bg-white p-5 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
      ...
      <div>
        ...
        <p class="text-2xl font-bold text-green-600">45,320</p>
      </div>
    ...
    <div
      ...
      <div
      class="bg-white h-48 rounded-lg flex items-center justify-center text-gray-400 border-2 border-dashed border-blue-100">
      [Insert Bar Chart]
      </div>
    </div>
...
<div>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    <!-- Club Card -->
    <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 border-t-4 border-green-400">
      <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-bold text-gray-800">🌿 Environment Club</h3>
        <span class="text-sm bg-green-100 text-green-700 px-2 py-1 rounded-full">#1</span>
      </div>
      <div class="grid grid-cols-3 gap-4 text-center">
        ...
        <div class="flex flex-col items-center">
          ...
          <div class="text-base font-semibold text-gray-700">530</div>
        </div>
        <!-- Revenue -->
        <div class="flex flex-col items-center">
    ...
    <!-- Club Card -->
    <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 border-t-4 border-blue-400">
      <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-bold text-gray-800">🔬 Science Club</h3>
        <span class="text-sm bg-blue-100 text-blue-700 px-2 py-1 rounded-full">#2</span>
      </div>
      <div class="grid grid-cols-3 gap-4 text-center">
        <!-- Fee -->
        <div class="flex flex-col items-center">
          ...
          <div class="text-base font-semibold text-gray-700">$90</div>
        </div>
        <!-- Members -->
        <div class="flex flex-col items-center">
          <svg class="w-6 h-6 text-blue-500 mb-1" fill="none" stroke="currentColor" stroke-width="2"
          ...
          <div class="text-base font-semibold text-gray-700">420</div>
        </div>
        <!-- Revenue -->
        <div class="flex flex-col items-center">
          <svg class="w-6 h-6 text-green-500 mb-1" fill="none" stroke="currentColor" stroke-width="2"
          ...
          <div class="text-base font-semibold text-green-600">$37.8k</div>
        </div>
      </div>
    </div>
